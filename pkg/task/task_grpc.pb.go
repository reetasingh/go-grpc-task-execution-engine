...
func (c *taskExecutionClient) ExecuteTask(ctx context.Context, in *TaskExecutionRequest, opts ...grpc.CallOption) (*TaskResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/task.TaskExecution/ExecuteTask", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskExecutionClient) GetTaskStatus(ctx context.Context, in *TaskStatusRequest, opts ...grpc.CallOption) (*TaskResponse, error) {
	out := new(TaskResponse)
	err := c.cc.Invoke(ctx, "/task.TaskExecution/GetTaskStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskExecutionClient) CancelTask(ctx context.Context, in *TaskStatusRequest, opts ...grpc.CallOption) (*TaskResponse, error) {
	out := new(TaskResponse)
	err := c.cc.Invoke(ctx, "/task.TaskExecution/CancelTask", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TaskExecution_ExecuteTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/task.TaskExecution/ExecuteTask",
	}
...
func _TaskExecution_GetTaskStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/task.TaskExecution/GetTaskStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaskExecution_CancelTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/task.TaskExecution/CancelTask",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var TaskExecution_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "task.TaskExecution",
